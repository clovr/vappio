...
OPTIONS = [
    ...
    ('params.OUTPUT_PREFIX', '', '--OUTPUT_PREFIX', 'Output prefix that will be used to name all output files', notNone),
    ('params.CROSSBOW_OPTS', '', '--CROSSBOW_OPTS', 'Any crossbow command-line arguments', defaultIfNone(""))
    ]

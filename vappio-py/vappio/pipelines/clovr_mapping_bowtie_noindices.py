...
OPTIONS = [
    ...
    ('input.REFERENCE_FILE_LIST', '', '--REFERENCE', 'The input reference bowtie-build generated indices', compose(lambda x : os.path.join('${dirs.tag_dir}/', x), notBlank, defaultIfNone('${input.REFERENCE_TAG}'))),

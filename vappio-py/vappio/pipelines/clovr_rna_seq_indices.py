...
OPTIONS = [
        ...
        ('input.REFERENCE_BOWTIE_PATH', '', '--REFERENCE_BOWTIE_PATH', 'The input reference bowtie-build generated indices', composeCLI(tagToRefDBPath, lambda x : os.path.join('${dirs.tag_dir}/', x), notBlank, defaultIfNone('${input.REFERENCE_BOWTIE_TAG}'))),

...
OPTIONS = [
    ...
    ('params.EXPECT', '', '--EXPECT', 'e-value cutoff, default is 1e-5', notNone),
    ##
    ...
    # str . int
    ('params.SEQS_PER_FILE', '', '--SEQS_PER_FILE', 'Number of sequences per file, defaults to 1000', compose(str, int, defaultIfNone('1000'))),

...
wget -P /tmp "http://iweb.dl.sourceforge.net/project/cdbfasta/tgi_cpp_library.tar.gz"
#wget -P /tmp ftp://occams.dfci.harvard.edu/pub/bio/tgi/software/cdbfasta/cdbfasta.tar.gz
wget -P /tmp "http://iweb.dl.sourceforge.net/project/cdbfasta/cdbfasta.tar.gz"

...
wget -N -P /mnt/ https://dl.dropboxusercontent.com/u/15490934/configure_sybil.working.pl
...
perl /mnt/configure_sybil.working.pl --start_mongo --install_sybil --install_postgres --root_dir=/mnt/ &> /mnt/configure_sybil.log
